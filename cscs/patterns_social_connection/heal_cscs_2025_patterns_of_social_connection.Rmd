...
factor_analysis_scores <- factor_analysis_results$scores %>% as.data.frame() %>% 
  rename(group_activities = ML1, 
         ...
         closed_meetings = ML4, # low varianace
         digital_activities = ML5) # low varianace
...
fviz_nbclust(cbind(factor_analysis_scores,pattern_scores), kmeans, method = "silhouette") #3 activity clusters
